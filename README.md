...
1. Проект [variables-and-conditions](./Task1/variables-and-conditions). Ссылка на [пример работы](/Task1/variables-and-conditions/variables-and-conditions.html).
...
2. Проект [cycles](./Task1/cycles). Ссылка на [пример работы](/Task1/cycles/cycles.html).
...
3. Проект [fizzbuzz](./Task1/fizzbuzz). Ссылка на [пример работы](/Task1/fizzbuzz/fizzbuzz.html).
...
4. Проект [quadratic](./Task1/quadratic). Ссылка на [пример работы](/Task1/quadratic/quadratic.html).
...
5. Проект [compression](./Task1/compression). Ссылка на [пример работы](/Task1/compression/compression.html).
...
6. Проект [countVowels](./Task1/countVowels). Ссылка на [пример работы](/Task1/countVowels/countVowels.html).
...
1. Проект [buttons-counter](./Task2/buttons-counter). Ссылка на [пример работы](/Task2/buttons-counter/buttons-counter.html).
...
2. Проект [pow-and-calculate](./Task2/pow-and-calculate). Ссылка на [пример работы](/Task2/pow-and-calculate/pow-and-calculate.html).
...
3. Проект [calcWithFunc](./Task2/calcWithFunc). Ссылка на [пример работы](/Task2/calcWithFunc/calcWithFunc.html).
...
4. Проект [methods](./Task2/methods). Ссылка на [пример работы](/Task2/methods/methods.html).
...
4. Проект [calendar](./Task2/calendar). Ссылка на [пример работы](/Task2/calendar/calendar.html).
...
4. Проект [method-counter](./Task2/method-counter). Ссылка на [пример работы](/Task2/method-counter/method-counter.html).
...
5. Проект [coctails](./Task2/coctails). Ссылка на [пример работы](/Task2/coctails/coctails.html).
...
6. Проект [class](./Task2/class). Ссылка на [пример работы](/Task2/class/class.html).
...
1. Проект [calendar](./Task3/calendar). Ссылка на [пример работы](/Task3/calendar/calendar.html).
...
2. Проект [editable-list](./Task3/editable-list). Ссылка на [пример работы](/Task3/editable-list/editable-list.html).
...
1. Проект [events](./Task4/events). Ссылка на [пример работы](/Task4/events/events.html).
...
2. Проект [calendar-with-selects](./Task4/calendar-with-selects). Ссылка на [пример работы](/Task4/calendar-with-selects/calendar-with-selects.html).
...
3. Проект [sortable-list](./Task4/sortable-list). Ссылка на [пример работы](/Task4/sortable-list/sortable-list.html).
...
1. Проект [clock](./Task5/clock). Ссылка на [пример работы](/Task5/clock/clock.html).
...
2. Проект [clock-svg](./Task5/clock-svg). Ссылка на [пример работы](/Task5/clock-svg/clock-svg.html).
...
3. Проект [clock-canvas](./Task5/clock-canvas). Ссылка на [пример работы](/Task5/clock-canvas/clock-canvas.html).
...
1. Проект [ping-pong_dom](./Task6/ping-pong_dom). Ссылка на [пример работы](/Task6/ping-pong_dom/ping-pong_dom.html).
...
2. Проект [ping-pong_svg](./Task6/ping-pong_svg). Ссылка на [пример работы](/Task6/ping-pong_svg/ping-pong_svg.html).
...
3. Проект [ping-pong_canvas](./Task6/ping-pong_canvas). Ссылка на [пример работы](/Task6/ping-pong_canvas/ping-pong_canvas.html).
...
1. Проект [birthday](./Task7/birthday). Ссылка на [пример работы](/Task7/birthday/birthday.html).
...
1. Проект [clocks-mvc](./Task8/clocks-mvc). Ссылка на [пример работы](/Task8/clocks-mvc/clocks-mvc.html).
